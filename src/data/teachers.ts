...
export const TEACHERS: Teacher[] = [
  {
    ...
    tibetanName: "ཆོས་ཀྱི་སྣང་བ་རིན་པོ་ཆེ།",
    ...
    bioHtml:
      "<p>His Eminence Choekyi Nangpa Rinpoche has resided in India since 1993. He received numerous empowerments and transmissions from His Holiness the 14th Dalai Lama, including the Hundred Guidance Instructions on the Kālacakra. In 1998, His Holiness appointed him Abbot of Jonang Monastery in Shimla. He also serves as Dorje Lopön (Vajra Master / Vajrācārya) for the monastery.</p><p>In 2014, he was appointed Jonang Gyaltsab Rinpoche, serving as the lineage representative in exile. Tulku Choekyi Nangpa Rinpoche holds the complete Jonang transmission lineages, with particular focus on the Kālacakra Tantra and its meditational deity cycles.</p><p>Rinpoche was entrusted with transmitting the lineage teachings by His Eminence Vajradhara (Dorje Chang) Ngawang Yonten Sangpo, his root guru. He instructs monks in Shimla according to classical Jonang tradition, directs retreatants of the Kālacakra Meditation Institute in the Six-fold Vajrayoga, and regularly travels to teach students across Europe, the Americas, and Asia.</p>",
  },
  {
    id: "66ed1b10bd6f15dd70d966e4",
    name: "Kunga Rinchen Rinpoche",
    tibetanName: "དགེ་བཤེས་ཀུན་དགའ་རིན་ཆེན།",
    ...
    bioHtml:
      "<p>Geshe Kunga Rinchen, the second abbot of Jonang Monastery in Shimla, India, was born in 1971 in the Ngawa region of Amdo. In 1985, he took monastic vows under Lama Kunga Thukje Palsangpo at Se Gönchen Monastery. He completed three years of intensive practice in the Six Yogas of the Kālacakra Tantra, followed by two years of solitary retreat focusing on Chöd and related meditative cycles.</p><p>In 1989, he received full monk ordination in the transmission lineage of Jetsun Tāranātha from Khar Sherab Choephel. That year, he also undertook ascetic retreat across one hundred charnel grounds (dur khrod) with Wugye Tulku Tenkho and Lama Kunga Loden.</p><p>In June 1990, Geshe Kunga Rinchen arrived in India. He completed a seventeen-year curriculum of dialectical study in the Collected Topics (Bsdus grwa) and the Five Great Treatises under former Drepung Gomang abbot Tsultrim Phentsok and other scholars. In 2007, he was awarded the Geshe Kachu (Master of the Ten Treatises) degree at Drepung Gomang Monastery.</p>",
  },
  {
    id: "66ed1be0bd6f15dd70d9670c",
    name: "Geshe Kunga Tsamchung Rinpoche",
    tibetanName: "དགེ་བཤེས་ཀུན་དགའ་མཚམས་ཆུང་།",
  ...
  },
  {
    ...
    bioHtml:
      "<p>Lama Yonten Gyamtso was born in 1966 into a rural family in Ngawa. He memorized root tantric treatises and liturgical manuals, successfully completing formal examinations at Se Gönchen Monastery. There, he studied the minor and major sciences under Vajradhara Kunga Thukje Pal. After passing his examinations on the Kālacakra Tantra, he entered the traditional three-year contemplative retreat.</p><p>Subsequently, he traveled to Lhasa for extended retreats, meditating in historic caves and secluded hermitages. He dedicated a decade to mastering Buddhist epistemology (Pramāṇa) and Middle Way philosophy. He taught philosophy for one year and conducted instructional classes in the Kālacakra ritual arts department for four years.</p><p>In late 1996, Lama Yonten Gyamtso arrived in India, studying Buddhist philosophy at the Institute of Buddhist Dialectics in Dharamsala before joining the core monastic assembly at Jonang Takten Phuntsok Choeling in Shimla. He now teaches internationally, with regular practice programs and centers in Russia and Europe.</p>",
  },
  {
    id: "66ed1cdbbd6f15dd70d96759",
    name: "Aku Kunga",
    tibetanName: "བླ་མ་ཨ་ཁུ་ཀུན་དགའ།",
    slug: "aku-kunga",
    roles: ["Lama"],
    order: 6,
    ...
    bioHtml:
      "<p>Lama Aku Kunga was born in April 1948 in the Amdo region of Tibet. In his youth, he entered Se Gönchen Monastery as an ordained monk.</p><p>He spent more than three years studying the history, cosmology, and completion-stage yogas (<em>Jordruk</em> / <em>Sbyor drug</em>) of the Kālacakra under Kunga Gyaltsen. He also received classical Tibetan grammar education from scholar Muge Samten. Lama Aku Kunga studied sūtra and tantra with masters including Tulku Urgyen Rinpoche and Chökyi Nyima Rinpoche. In India, he was a close disciple of the 9th Khalkha Jetsun Dampa Khutuktu, focusing on Chöd and tantric ritual practices.</p>",
  },
];
