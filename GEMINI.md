...
| `font-tibetan-scholarly` | `Jomolhari`, `Noto Serif Tibetan`, `serif` | **Classical Scripture:** Root verses (*rtsa ba*), philosophical treatises, and pecha citations (`line-height: 1.85`). |
